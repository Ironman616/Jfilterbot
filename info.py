...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002134871596'))  # set shortner log channel
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002134871596') # If anyone sends a request message to your bot, you will get it in this channel.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://loki-22jan-v1-6c557a0ec51f.herokuapp.com/")
